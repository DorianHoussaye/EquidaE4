...
<footer class="page-footer light-green darken-4">
    <div class="container">
        <div class="row">
            <div class="col s3">
                <p><a href="/EquidaE4/ServletFooter/qui_sommes_nous" class="white-text"> Qui sommes-nous ? </a></p>
                <p><a href="/EquidaE4/ServletFooter/contact" class="white-text"> Contact </a></p>
            </div>

            <div class="col s2"> 
                <p><a href="/EquidaE4/ServletFooter/mentions_legales" class="white-text"> Mentions légales </a></p>
            </div>
        </div>
    </div>
