...
<ul id="dropdownVente" class="dropdown-content">
    <li><a href="/Equidor/ServletVentes/venteAjouter">Ajouter une vente</a></li>
    <li class="divider"></li>
    <li><a href="/Equidor/ServletCategVente/listerLesCategVentes">Lister les catégories de vente</a></li>
    <li class="divider"></li>
    <li><a href="/Equidor/ServletCategVente/categorieVenteAjouter">Ajouter les catégories de vente</a></li>
</ul>

<ul id="dropdownClient" class="dropdown-content">
    <li><a href="/Equidor/ServletClient/listerLesClientsPrDirGen">Lister les clients</a></li>
    <li class="divider"></li>
    <li><a href="/Equidor/ServletClient/ajouterClient">Ajouter un client</a></li>
</ul>

<ul id="dropdownCheval" class="dropdown-content">
    <li><a href="/Equidor/ServletTypeCheval/typeChevalAjouter">Ajouter une race</a></li>
    <li class="divider"></li>
    <li><a href="/Equidor/ServletTypeCheval/listerLesTypeCheval">Lister les races de chevaux</a></li>
</ul>

<ul id="dropdownPays" class="dropdown-content">
    <li><a href="/Equidor/ServletPays/paysAjouter">Ajouter un pays</a></li>
    <li class="divider"></li>
    <li><a href="/Equidor/ServletPays/listerLesPays">Lister les pays</a></li>
</ul>

<ul id="dropdownLieu" class="dropdown-content">
    <li><a href="/Equidor/ServletLieu/ajouterLieu">Ajouter un lieu</a></li>
    <li class="divider"></li>
    <li><a href="/Equidor/ServletLieu/lieuLister">Lister les lieux</a></li>
</ul>

<ul id="dropdownCourses" class="dropdown-content">
	<li><a href="/Equidor/ServletCourse/courseAjouter">Ajouter une course</a></li>
	<li class="divider"></li>
	<li><a href="/Equidor/ServletCourse/listerLesCourses">Lister les courses</a></li>
</ul>
